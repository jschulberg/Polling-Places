...
#     the House elections in a given state is determinate of the number of polling sites in that
...
## Future Analysis
# This article really is just a small look at one facet of elections: polling places. Where else
# should this article go? Well, if I could get my hands on elections data smaller at the county-level
# or even more granular, I could run a lot of the previous analyses on a much more robust dataset.
